        ...
        <Box className={classes.root}>
            ...
            <form onSubmit={onSubmit}>
                <FormControl className={classes.formControl}>
                    ...
                    <Input className={classes.input} id="email" type="email" name="email" value={email} onChange={e => setEmail(e.target.value)} required/>
                </FormControl>
            ...
            <FormHelperText className={classes.helperText}>Already a user? Click <Link to='/login' className={classes.link}>here</Link> to login now!</FormHelperText>
        </Box>
    )
}
